  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="relative min-h-[90vh] flex items-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
            <div className="max-w-3xl">
              <p className="text-primary font-semibold text-sm uppercase tracking-wider mb-4">BLUE CRESTA FX Prop Firm</p>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              <div>
                ...
                <p className="text-muted-foreground text-lg leading-relaxed mb-6">
                  BLUE CRESTA FX Prop Firm is designed to empower modern trading businesses with a powerful and scalable proprietary trading infrastructure. Our platform provides everything needed to launch, manage, and scale a professional prop trading firm with ease.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  From challenge management to trader funding systems, BLUE CRESTA FX offers a complete ecosystem that connects technology, capital, and traders on one unified platform. Whether you are launching a new prop firm or expanding an existing operation, BLUE CRESTA FX delivers the tools and infrastructure required for growth.
                </p>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
                At BLUE CRESTA FX, our mission is to build a transparent, efficient, and technology-driven environment for proprietary trading firms.
              </p>
            </div>
            ...
            <p className="text-center text-muted-foreground mt-12 max-w-2xl mx-auto">
              BLUE CRESTA FX stands for innovation, stability, and empowering financial businesses through advanced trading technology.
            </p>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-white/80 text-lg leading-relaxed mb-6">
                  BLUE CRESTA FX bridges the gap between talented traders and institutional-level infrastructure.
                </p>
                <p className="text-white/70 leading-relaxed mb-8">
                  Our system enables firms to provide traders with structured evaluation programs, automated funding processes, and professional trading tools. With advanced dashboards, risk management systems, and real-time data integration, BLUE CRESTA FX ensures traders and firms operate within a secure and efficient ecosystem.
                </p>
                <div className="flex items-center gap-3 text-white/90">
                  <CheckCircle2 className="w-5 h-5 text-primary" />
                  <span>By combining cutting-edge technology with capital access, BLUE CRESTA FX creates new opportunities for traders to grow and scale.</span>
                </div>
              </div>
        ...
        <section className="py-20 lg:py-28 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
                BLUE CRESTA FX provides a unified environment where all prop firm operations can be managed from a single platform. This centralized system reduces operational complexity and allows firms to focus on growth and trader performance.
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              <div>
                ...
                <p className="text-gray-700 text-lg leading-relaxed mb-6">
                  BLUE CRESTA FX delivers a comprehensive technology stack designed specifically for proprietary trading firms.
                </p>
        ...
        <section className="py-20 lg:py-28 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
                BLUE CRESTA FX provides a fully integrated infrastructure required to operate a professional prop trading firm. Every component works together seamlessly to ensure smooth operations for both administrators and traders.
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white border border-border rounded-2xl overflow-hidden hover:shadow-xl transition-all duration-300">
                ...
                <div className="p-6">
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    BLUE CRESTA FX integrates advanced charting technology powered by BlackTrader to deliver fast, responsive, and data-rich market analysis tools.
                  </p>
              ...
              <div className="bg-white border border-border rounded-2xl overflow-hidden hover:shadow-xl transition-all duration-300">
                ...
                <div className="p-6">
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    BLUE CRESTA FX also supports TradingView integration, providing traders with one of the most trusted charting solutions in the financial industry.
                  </p>
                  <div className="flex flex-wrap gap-2">
        ...
        <section className="py-20 lg:py-28 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
                BLUE CRESTA FX provides a centralized management system that allows administrators to control every aspect of their prop firm operations. With a dedicated admin dashboard and intelligent reporting systems, firms gain complete visibility and control.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-white border border-border rounded-2xl p-8 hover:shadow-xl transition-all duration-300">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  BLUE CRESTA FX enables firms to create and manage structured evaluation challenges for traders.
                </p>
              ...
              <div className="bg-white border border-border rounded-2xl p-8 hover:shadow-xl transition-all duration-300">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  BLUE CRESTA FX includes a secure payment management system that allows firms to handle trader purchases, challenge fees, and payout processes efficiently.
                </p>
                <p className="text-muted-foreground text-sm leading-relaxed">
              ...
              <div className="bg-white border border-border rounded-2xl p-8 hover:shadow-xl transition-all duration-300">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  BLUE CRESTA FX allows prop firms to design customized challenge programs based on their business model.
                </p>
                <p className="text-muted-foreground text-sm leading-relaxed">
        ...
        {/* Risk Disclaimer */}
        <section className="py-8 bg-[#0A0D1A]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
